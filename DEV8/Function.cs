    ...
    class Function
    {
        public void carf()
        {
            ...
            while (true)
            {
                ...
                {
                    ii++;
                    type = carname.CarInputType();
                    string model = carname.CarInputModel();
                    int count = carname.CarInputCount();
                    int price = carname.CarInputPrice();
                    ...
                    /*  if (command.Equals("average price" + " " + type))
                      {
                          ...
                          Console.WriteLine("average price "+type+":" + totalpriceb / gg);
                      }*/
                    if (!command.Equals("count types") && !command.Equals("count all") && !command.Equals("average price") && !command.Equals("average price" + " " + type))
                    {
